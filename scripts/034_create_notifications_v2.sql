...
DROP POLICY IF EXISTS "Users can manage own email preferences" ON public.email_preferences;
...
BEGIN
  ...
  SELECT submitted_by, title INTO template_owner, template_name
  FROM public.templates
  WHERE id = NEW.template_id;
  
  -- Only create notification if template has an owner
  IF template_owner IS NOT NULL THEN
